...
class tokokoo_facebook_fans extends WP_Widget {
	...
	function __construct() {
		...
		$widget_ops = array( 
			...
			'description' => __( 'A custom widget to display the Facebook fans page box.', 'tokokoo' ) 
		);
		...
		parent::__construct( 'tokokoo_fb_widget', __( 'Tokokoo - Facebook Fans Widget', 'tokokoo' ), $widget_ops, $control_ops );
	...
	?>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'fb_url' ) ); ?>"><?php _e( 'Facebook Page URL:', 'tokokoo' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'connections' ) ); ?>"><?php _e( 'Connection:', 'tokokoo' ); ?></label>
