...
class tokokoo_ads extends WP_Widget {
	...
	function __construct() {
		...
		$widget_ops = array(
			...
			'description' => __( 'A custom widget to display any type of Ad as a widget.', 'tokokoo' )
		);
		...
		parent::__construct( 'tokokoo_ads_widget', __( 'Tokokoo - Advertisement', 'tokokoo' ), $widget_ops, $control_ops );
	...
	?>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'adcode' ); ?>"><?php _e( 'Ad Code:', 'tokokoo' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'imgurl' ) ); ?>"><?php _e( 'Image URL:', 'tokokoo' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'linkurl' ) ); ?>"><?php _e( 'Link:', 'tokokoo' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'alttext' ) ); ?>"><?php _e( 'Alt Text:', 'tokokoo' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'target' ) ); ?>"><?php _e( 'Link Target:', 'tokokoo' ); ?></label>
			<select class="widefat" name="<?php echo esc_attr( $this->get_field_name( 'target' ) ); ?>" id="<?php echo esc_attr( $this->get_field_id( 'target' ) ); ?>">
				<option value="_self" <?php selected( $target, '_self' ); ?>><?php _e( 'Open in the same window', 'tokokoo' ); ?></option>
				<option value="_blank" <?php selected( $target, '_blank' ); ?>><?php _e( 'Open in a new window', 'tokokoo' ); ?></option>
			</select>
		</p>
		<p>
