...
class tokokoo_testimonials extends WP_Widget {
	...
	function __construct() {
		...
		$widget_ops = array( 
			...
			'description' => __( 'A custom widget that display three testimonials.', 'tokokoo' ) 
		);
		...
		parent::__construct( 'tokokoo_testimonials_widget', __( 'Tokokoo - Testimonials', 'tokokoo' ), $widget_ops, $control_ops );
	...
	<div class="hybrid-widget-controls columns-3">
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'link' ) ); ?>"><?php _e( 'URL:', 'tokokoo' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'name' ) ); ?>"><?php _e( 'Name:', 'tokokoo' ); ?></label>
			<input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'name' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'name' ) ); ?>" type="text" value="<?php echo $name; ?>" />
		</p>
		<p>
			<label for="<?php echo $this->get_field_id( 'desc' ); ?>"><?php _e( 'Testimonial:', 'tokokoo' ); ?></label>
	...
	<div class="hybrid-widget-controls columns-3">
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'link2' ) ); ?>"><?php _e( 'URL:', 'tokokoo' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'name2' ) ); ?>"><?php _e( 'Name:', 'tokokoo' ); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'desc2' ); ?>"><?php _e( 'Testimonial:', 'tokokoo' ); ?></label>
	...
	<div class="hybrid-widget-controls columns-3 column-last">
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'link3' ) ); ?>"><?php _e( 'URL:', 'tokokoo' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'name3' ) ); ?>"><?php _e( 'Name:', 'tokokoo' ); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'desc3' ); ?>"><?php _e( 'Testimonial:', 'tokokoo' ); ?></label>
