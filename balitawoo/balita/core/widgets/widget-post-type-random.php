...
class tokokoo_random_post_type extends WP_Widget {
	...
	function __construct() {
		...
		$widget_ops = array(
			...
			'description' => __( 'A custom widget to display random data from any post type.', 'tokokoo' )
		);
		...
		parent::__construct( 'tokokoo_random_post_type_widget', __( 'Tokokoo - Post Type Random', 'tokokoo' ), $widget_ops, $control_ops );
