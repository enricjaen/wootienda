...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => __( 'No Repeat', 'tokokoo' ),
		'repeat-x'  => __( 'Repeat Horizontally', 'tokokoo' ),
		'repeat-y'  => __( 'Repeat Vertically', 'tokokoo' ),
		'repeat'    => __( 'Repeat All', 'tokokoo' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __( 'Top Left', 'tokokoo' ),
		'top center'    => __( 'Top Center', 'tokokoo' ),
		'top right'     => __( 'Top Right', 'tokokoo' ),
		'center left'   => __( 'Middle Left', 'tokokoo' ),
		'center center' => __( 'Middle Center', 'tokokoo' ),
		'center right'  => __( 'Middle Right', 'tokokoo' ),
		'bottom left'   => __( 'Bottom Left', 'tokokoo' ),
		'bottom center' => __( 'Bottom Center', 'tokokoo' ),
		'bottom right'  => __( 'Bottom Right', 'tokokoo')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __( 'Scroll Normally', 'tokokoo' ),
		'fixed'  => __( 'Fixed in Place', 'tokokoo')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => __( 'Normal', 'tokokoo' ),
		'italic'      => __( 'Italic', 'tokokoo' ),
		'bold'        => __( 'Bold', 'tokokoo' ),
		'bold italic' => __( 'Bold Italic', 'tokokoo' )
	);
