...
class tokokoo_opening_hours extends WP_Widget {
	...
	function __construct() {
		...
		$widget_ops = array(
			...
			'description' => __( 'A custom widget to display business hours.', 'tokokoo' )
		);
		...
		parent::__construct( 'tokokoo_opening_hours_widget', __( 'Tokokoo - Business Hours', 'tokokoo' ), $widget_ops, $control_ops );
	...
	function widget( $args, $instance ) {
		...
		if ( ! empty( $title ) )
			...
			echo '<ul class="no-list-style">';
				if( $mon ) {
					printf ( __( '<li><span class="day">Monday: </span>%s</li>', 'tokokoo' ), $mon );
				} 
				if( $tue ) {
					printf ( __( '<li><span class="day">Tuesday: </span>%s</li>', 'tokokoo' ), $tue );
				}
				if( $wed ) {
					printf ( __( '<li><span class="day">Wednesday: </span>%s</li>', 'tokokoo' ), $wed );
				}
				if( $thu ) {
					printf ( __( '<li><span class="day">Thursday: </span>%s</li>', 'tokokoo' ), $thu );
				}
				if( $fri ) {
					printf ( __( '<li><span class="day">Friday: </span>%s</li>', 'tokokoo' ), $fri );
				}
				if( $sat ) {
					printf ( __( '<li><span class="day">Saturday: </span>%s</li>', 'tokokoo' ), $sat );
				}
				if( $sun ) {
					printf ( __( '<li><span class="day">Sunday: </span>%s</li>', 'tokokoo' ), $sun );
				}
			echo '</ul>';
	...
	?>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'mon' ) ); ?>"><?php _e( 'Monday:', 'tokokoo' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'tue' ) ); ?>"><?php _e( 'Tuesday:', 'tokokoo' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'wed' ) ); ?>"><?php _e( 'Wednesday:', 'tokokoo' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'thu' ) ); ?>"><?php _e( 'Thursday:', 'tokokoo' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'fri' ) ); ?>"><?php _e( 'Friday:', 'tokokoo' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'sat' ) ); ?>"><?php _e( 'Saturday:', 'tokokoo' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'sun' ) ); ?>"><?php _e( 'Sunday:', 'tokokoo' ); ?></label>
