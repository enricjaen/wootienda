...
class tokokoo_video_widget extends WP_Widget {
	...
	function __construct() {
		...
		$widget_ops = array( 
			...
			'description' => __( 'A custom widget to display video such as from youtube, vimeo and etc.', 'tokokoo' ) 
		);
		...
		parent::__construct( 'tokokoo_video_widget', __( 'Tokokoo - Video', 'tokokoo' ), $widget_ops, $control_ops );
	...
	?>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'video_url' ) ); ?>"><?php _e( 'Video URL:', 'tokokoo' ); ?></label>
