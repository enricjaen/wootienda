...
class tokokoo_social extends WP_Widget {
	...
	function __construct() {
		...
		$widget_ops = array( 
			...
			'description' => __( 'A custom widget to display the social network icons.', 'tokokoo' ) 
		);
		...
		parent::__construct( 'tokokoo_social_widget', __( 'Tokokoo - Social Connect', 'tokokoo' ), $widget_ops, $control_ops );
	...
	<div class="hybrid-widget-controls columns-3">
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'rss' ) ); ?>"><?php _e( 'Rss URL:', 'tokokoo' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'email_id' ) ); ?>"><?php _e( 'Email:', 'tokokoo' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'twitter_id' ) ); ?>"><?php _e( 'Twitter Username:', 'tokokoo' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'fb_id' ) ); ?>"><?php _e( 'Facebook Username:', 'tokokoo' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'gplus_id' ) ); ?>"><?php _e( 'Google Plus Username:', 'tokokoo' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'ytube_id' ) ); ?>"><?php _e( 'Youtube Username:', 'tokokoo' ); ?></label>
	...
	<div class="hybrid-widget-controls columns-3">
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'flickr_id' ) ); ?>"><?php _e( 'Flickr Username:', 'tokokoo' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'linkedin_id' ) ); ?>"><?php _e( 'Linkedin Username:', 'tokokoo' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'pinterest_id' ) ); ?>"><?php _e( 'Pinterest Username:', 'tokokoo' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'dribbble_id' ) ); ?>"><?php _e( 'Dribbble Username:', 'tokokoo' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'github_id' ) ); ?>"><?php _e( 'Github Username:', 'tokokoo' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'lastfm_id' ) ); ?>"><?php _e( 'Last FM Username:', 'tokokoo' ); ?></label>
	...
	<div class="hybrid-widget-controls columns-3 column-last">
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'vimeo_id' ) ); ?>"><?php _e( 'Vimeo Username:', 'tokokoo' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'tumblr_id' ) ); ?>"><?php _e( 'Tumblr Username:', 'tokokoo' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'instagram_id' ) ); ?>"><?php _e( 'Instagram Username:', 'tokokoo' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'soundcloud_id' ) ); ?>"><?php _e( 'Soundcloud Username:', 'tokokoo' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'behance_id' ) ); ?>"><?php _e( 'Behance Username:', 'tokokoo' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'deviantart_id' ) ); ?>"><?php _e( 'Deviantart Username:', 'tokokoo' ); ?></label>
