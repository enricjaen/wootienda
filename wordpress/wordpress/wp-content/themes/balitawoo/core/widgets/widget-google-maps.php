...
class tokokoo_google_maps extends WP_Widget {
	...
	function __construct() {
		...
		$widget_ops = array( 
			...
			'description' => __( 'A custom widget to display Google Maps based on your address.', 'tokokoo' ) 
		);
		...
		parent::__construct( 'tokokoo_google_maps', __( 'Tokokoo - Google Maps', 'tokokoo' ), $widget_ops, $control_ops );
	}
	...
	<div class="hybrid-widget-controls columns-2">
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'country' ) ); ?>"><?php _e( 'Country:', 'tokokoo' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'state' ) ); ?>"><?php _e( 'State:', 'tokokoo' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'city' ) ); ?>"><?php _e( 'City:', 'tokokoo' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'street' ) ); ?>"><?php _e( 'Street:', 'tokokoo' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'zip' ) ); ?>"><?php _e( 'Zip:', 'tokokoo' ); ?></label>
	...
	<div class="hybrid-widget-controls columns-2 column-last">
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'type' ) ); ?>"><?php _e( 'Type', 'tokokoo' ); ?>:</label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'width' ) ); ?>"><?php _e( 'Width:', 'tokokoo' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'height' ) ); ?>"><?php _e( 'Height:', 'tokokoo' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'zoom' ) ); ?>"><?php _e( 'Zoom:', 'tokokoo' ); ?></label>
