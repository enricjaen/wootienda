...
class tokokoo_contact extends WP_Widget {
	...
	function __construct() {
		...
		$widget_ops = array( 
			...
			'description' => __( 'A custom widget to display your contact details.', 'tokokoo' ) 
		);
		...
		parent::__construct( 'tokokoo_contact_widget', __( 'Tokokoo - Contact Info', 'tokokoo' ), $widget_ops, $control_ops );
	}
	...
	?>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'summary' ); ?>"><?php _e( 'Summary:', 'tokokoo' ); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'address' ); ?>"><?php _e( 'Address:', 'tokokoo' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'email' ) ); ?>"><?php _e( 'Email:', 'tokokoo' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'phone' ) ); ?>"><?php _e( 'Phone:', 'tokokoo' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'fax' ) ); ?>"><?php _e( 'Fax:', 'tokokoo' ); ?></label>
